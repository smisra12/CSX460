...
setwd("C:/Users/smisra/tmp/CSX460/02-fundamentals")
...
flights_WeatherInfo <- flights_wPlaneInfo %>% 
  ...
  select(year.x, month.x, day.x, dep_time, sched_dep_time, dep_delay, arr_time, sched_arr_time, arr_delay, carrier, flight, tailnum, origin, dest, distance, hour.x, minute, time_hour, flight_date, type, manufacturer, model, engines, seats, speed, engine)
